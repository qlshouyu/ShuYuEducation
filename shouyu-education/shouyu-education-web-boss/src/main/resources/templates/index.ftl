...
<title>授鱼教育系统 - 开源版</title>
<meta name="Keywords" content="授鱼教育系统 - 运营后台" />
<meta name="Description" content="授鱼教育系统 - 运营后台" />
	...
	<div id="bjui-window">
		<header id="bjui-header">
			<div class="bjui-navbar-header">
				...
				<span class="bjui-navbar-logo" style="color:#fff;"><h4>授鱼教育系统 - 开源版</h4></span>
			</div>
		...
		<footer id="bjui-footer">
			Copyright &copy; 2015 - <span id="y"></span>&nbsp;<a href="http://www.roncoo.net/" target="_blank">鼎斗信息科技有限公提供技术支持</a>
