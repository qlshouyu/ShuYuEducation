...
import com.shouyu.education.course.common.bean.qo.OrderEchartsQO;
import com.shouyu.education.course.common.bean.qo.OrderInfoQO;
import com.shouyu.education.course.common.bean.vo.CountIncomeVO;
import com.shouyu.education.course.common.bean.vo.OrderEchartsVO;
import com.shouyu.education.course.common.bean.vo.OrderInfoVO;
import com.shouyu.education.course.common.bean.vo.OrderReportVO;
...
public class BossOrderInfoBiz extends BaseBiz {
	...
	public int handleScheduledTasks() {
		...
		com.shouyu.education.course.service.dao.impl.mapper.entity.OrderPayExample.Criteria orderPayCriteria = orderPayExample.createCriteria();
