 ...
 */
package com.shouyu.education.util.base;
...
import com.shouyu.education.util.enums.AdvTargetEnum;
import com.shouyu.education.util.enums.AuditStatusEnum;
import com.shouyu.education.util.enums.CategoryTypeEnum;
import com.shouyu.education.util.enums.ChannelTypeEnum;
import com.shouyu.education.util.enums.CourseCategoryEnum;
import com.shouyu.education.util.enums.CourseTypeEnum;
import com.shouyu.education.util.enums.ExtractStatusEnum;
import com.shouyu.education.util.enums.FileTypeEnum;
import com.shouyu.education.util.enums.IsDefaultEnum;
import com.shouyu.education.util.enums.IsEnableStatisticsEnum;
...
import com.shouyu.education.util.enums.IsSendEnum;
import com.shouyu.education.util.enums.IsShowServiceEnum;
import com.shouyu.education.util.enums.IsSuccessEnum;
import com.shouyu.education.util.enums.IsTimeSendEnum;
import com.shouyu.education.util.enums.MsgTypeEnum;
import com.shouyu.education.util.enums.NavEnum;
import com.shouyu.education.util.enums.OrderStatusEnum;
import com.shouyu.education.util.enums.PayTypeEnum;
import com.shouyu.education.util.enums.PlatformEnum;
import com.shouyu.education.util.enums.ProfitStatusEnum;
import com.shouyu.education.util.enums.SexEnum;
import com.shouyu.education.util.enums.StatusIdEnum;
import com.shouyu.education.util.enums.SysTypeEnum;
import com.shouyu.education.util.enums.TradeStatusEnum;
import com.shouyu.education.util.enums.TradeTypeEnum;
import com.shouyu.education.util.enums.UserTypeEnum;
import com.shouyu.education.util.enums.VideoStatusEnum;
import com.shouyu.education.util.enums.VideoTypeEnum;
import com.shouyu.education.util.enums.ZoneLocationEnum;
import com.shouyu.education.util.tools.JSONUtil;
